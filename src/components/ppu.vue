<template>
    ...
    <canvas id="screen" class="screen w-full" width="256" height="240"></canvas>
    </div>
    ...
    <div class="col-sm-12 col-md-6">
    <table v-if="inDebug" class="text-white">
...
<script>
import {isBitSet, colors, PRIORITY_FOREGROUND, PRIORITY_BACKGROUND} from '../util'
export default {
  props: ["console"],
  data: function () {
    return {
